...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/RestraintVoiceBoost/">RestraintVoiceBoost</a><a href="https://github.com/RestraintVoiceBoost/zaprettelegram">/zaprettelegram</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
<!-- gbzap-pages-link -->
**Страница сборки:** [https://restraintvoiceboost.github.io/zaprettelegram/](https://restraintvoiceboost.github.io/zaprettelegram/)

> [!CAUTION]
>
> ### ФЕЙКИ
> Я не веду никакие другие страницы/группы в телеграм/ютуб каналы  
> Если вы наткнулись на что-то вне репозитория `RestraintVoiceBoost/zaprettelegram`, что распространяется от моего лица - **ФЕЙК**.
...
> [!IMPORTANT]
> Все бинарные файлы в папке [`bin`](./bin) взяты из [zapret-win-bundle/zapret-winws](https://github.com/bol-van/zapret-win-bundle/tree/master/zapret-winws) и [zapret/releases](https://github.com/RestraintVoiceBoost/zaprettelegram/releases/latest). Вы можете это проверить с помощью хэшей/контрольных сумм. Проверяйте, что запускаете, используя сборки из интернета!
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/RestraintVoiceBoost/zaprettelegram/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/RestraintVoiceBoost/zaprettelegram/issues/522)
...
- См. [#765](https://github.com/RestraintVoiceBoost/zaprettelegram/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/RestraintVoiceBoost/zaprettelegram/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/RestraintVoiceBoost/zaprettelegram/discussions/251)
...
- См. также [#252](https://github.com/RestraintVoiceBoost/zaprettelegram/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/RestraintVoiceBoost/zaprettelegram/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/RestraintVoiceBoost/zaprettelegram/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/RestraintVoiceBoost/zaprettelegram/blob/main/LICENSE.txt)

## 🩷Благодарность участникам проекта

](https://github.com/RestraintVoiceBoost/zaprettelegram/graphs/contributors)
